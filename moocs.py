...
def Wait_exists(driver, id: str=None, name:str=None, frame=None):
    while True:
        if id != None:
...
def Get_course_names_and_course_elements(driver):
